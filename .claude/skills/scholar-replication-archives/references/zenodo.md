...
**Key Stats**: Elasticsearch-based search, 50GB per file (new API), DOI registration
**Best For**: Publication-linked datasets, multidisciplinary research, versioned outputs
