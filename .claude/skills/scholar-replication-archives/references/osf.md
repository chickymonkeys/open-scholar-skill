...
**Key Stats**: JSON-API v2, 10,000 requests/day (authenticated), 100/hour (unauthenticated) **Best For**: Project-based research, preprints, multi-component studies **Documentation**: <https://developer.osf.io/>
