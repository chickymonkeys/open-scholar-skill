...
This mode loads no companion reference: its collaborators (scholar-write, scholar-verify, scholar-code-review, the `_shared/` protocols) are loaded inline in Steps 2–3.
